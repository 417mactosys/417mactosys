...
class CameraView extends StatefulWidget {
  //final bool rear;
  //CameraView();
  final _CameraViewState state = _CameraViewState();
  toggle() {
    state.toggleCam();
  }

  @override
  _CameraViewState createState() => state;
}
...
// Modify the yScale if you are in Landscape
      ...
      return Listener(
        ...
        child: Container(
          ...
          child: Transform.scale(
            scale: cameraController.value.aspectRatio * 0.6,
            //scale: 1.0,
            child: CameraPreview(
              controller,
              child: LayoutBuilder(
  ...
  toggleCam() {
    final d = controller?.description == CAMERAS[0] ? CAMERAS[1] : CAMERAS[0];
    onNewCameraSelected(d);
  }
